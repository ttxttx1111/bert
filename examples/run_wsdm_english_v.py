...
def main():
    ...
    parser.add_argument('--checkpoint_path',
                        type=str, default=base_dir + "/input/model/chinese_base/chinese_base_epoch_2_part_train.dat",
                        help='The path of checkpoint to load from')

    if full_train:
        parser.add_argument('--cached_train_examples', type=str, default=base_dir+'/input/'+model_type+'/cached_train_full_examples.dat')
        parser.add_argument('--cached_train_features', type=str, default=base_dir + '/input/'+model_type+'/cached_train_full_features.dat')
    else:
    ...
    parser.add_argument('--cached_dev_examples', type=str, default=base_dir + '/input/'+model_type+'/cached_dev_examples.dat')
    parser.add_argument('--cached_dev_features', type=str, default=base_dir + '/input/'+model_type+'/cached_dev_features.dat')
    parser.add_argument('--cached_test_examples', type=str, default=base_dir + '/input/'+model_type+'/cached_test_examples.dat')
    parser.add_argument('--cached_test_features', type=str, default=base_dir + '/input/'+model_type+'/cached_test_features.dat')
